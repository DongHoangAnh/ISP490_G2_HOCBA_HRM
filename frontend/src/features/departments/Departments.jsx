...
export default function Departments({ search = '' }) {
  ...
  // Chốt 2026-08-15: HR officer (hr.group_hr_user) CHỈ XEM; thêm/sửa/lưu trữ
  // dành cho HR Manager + Admin. Cờ lấy từ API (_cap_edit_dept) — backend vẫn
  // chặn độc lập, đây chỉ là lớp ẩn nút.
